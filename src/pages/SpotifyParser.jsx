...
export default function SpotifyParser() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 pt-16">
      ...
      <h1 className="text-4xl font-bold mb-2 text-slate-300">Spotify Listening History Parser</h1>
      <p className="text-slate-400 mb-10">Parse and analyze your Spotify listening history</p>
      ...
      <Link to="/math-data" className="text-slate-400 hover:text-white transition-colors text-sm">&larr; Back to Math & Data</Link>
    </div>
  )
}
